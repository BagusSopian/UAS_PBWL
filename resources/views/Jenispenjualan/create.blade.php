                                                ...
                                                <div class="tab-pane tab-example-design fade show active" id="pills-basic-forms-design" role="tabpanel" aria-labelledby="pills-basic-forms-design-tab">
                                                    <form action="/jenis-penjualan" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            @enderror
                                                            <label class="form-label" for="textInput">Jenis
                                                                Penjualan</label>
                                                            <input type="text" id="jenis_penjualan" class="form-control" placeholder="Masukan Jenis Penjualan" name="jenis_penjualan">
                                                        </div>
                                                        <div class="row">
                                                            <div class="col">
                                                            ...
                                                            <div class="col"></div>
                                                            <div class="col-3">
                                                                <a href="{{ route('jenis-penjualan.index') }}" class="btn btn-outline-warning text-end">Kembali</a>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
