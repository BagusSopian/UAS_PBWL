                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped text-center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $key->barang_penjualan->jenis_penjualan->jenis_penjualan }}
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <form action="/master-penjualan/{{$key->id}}"
                                                                    method="POST" class="display-non">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                    <button type=" submit"
                                                ...
                                                <div>
                                                    <div class="d-flex justify-content-end">
                                                        {{ $tpenjualan->links('vendor.pagination.custom') }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
